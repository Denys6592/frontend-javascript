...
const InviteTalent = ({
  ...
  return (
    <div className="flex flex-col gap-4 p-10">
      <div
        className="border-b border-gray-200 justify-start items-center gap-2.5 inline-flex">
        <button
          className="px-2 border-b-2 border-gray-700 justify-center items-center gap-2.5 flex">
      ...
      <div className="flex-col justify-start items-start gap-2 inline-flex">
        <div className="self-stretch justify-start items-center gap-2.5 inline-flex">
          <div
            className="grow shrink basis-0 px-4 py-3 rounded-lg border border-gray-200 justify-start items-center gap-2.5 flex">
          ...
          <div
            className="px-2 py-2.5 rounded-lg border border-emerald-500 justify-center items-center gap-1 flex">
            <div data-svg-wrapper className="relative">
              <svg
                width="20"
                height="20"
