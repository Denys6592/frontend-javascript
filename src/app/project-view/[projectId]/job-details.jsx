"use client";;
import { formatDate, getCountryName } from "@/utils/constant";

const JobDetails = ({ project, proposalCount }) => {
  return (
    <div className="flex p-10">
      <div className="flex flex-col">
        <div
          className="p-6 border-b border-gray-200 flex-col justify-start items-start gap-2.5 inline-flex">
            ...
            <div className="justify-center items-center gap-2.5 flex">
              <div data-svg-wrapper className="relative">
                <svg
                  ...
                  <path
                    d="M5.83301 15C4.3089 15.3431 3.33301 15.8703 3.33301 16.4614C3.33301 17.4953 6.31777 18.3333 9.99967 18.3333C13.6816 18.3333 16.6663 17.4953 16.6663 16.4614C16.6663 15.8703 15.6904 15.3431 14.1663 15"
                    stroke="#141B34"
                    stroke-width="1.5"
                    stroke-linecap="round" />
                  <path
                    d="M12.0837 7.49935C12.0837 8.64993 11.1509 9.58268 10.0003 9.58268C8.84974 9.58268 7.91699 8.64993 7.91699 7.49935C7.91699 6.34876 8.84974 5.41602 10.0003 5.41602C11.1509 5.41602 12.0837 6.34876 12.0837 7.49935Z"
                    stroke="#141B34"
                    stroke-width="1.5" />
                  <path
                    d="M11.0482 14.5774C10.7671 14.848 10.3914 14.9993 10.0005 14.9993C9.60949 14.9993 9.23383 14.848 8.95274 14.5774C6.37891 12.0834 2.92965 9.29727 4.61175 5.25246C5.52124 3.06545 7.70444 1.66602 10.0005 1.66602C12.2965 1.66602 14.4797 3.06546 15.3892 5.25246C17.0692 9.29218 13.6283 12.0919 11.0482 14.5774Z"
                    stroke="#141B34"
                    stroke-width="1.5" />
                </svg>
              </div>
        ...
        <div
          ...
          <div className="self-stretch justify-center items-center gap-4 inline-flex">
            <div
              className="grow shrink basis-0 text-[#171718] text-base font-normal leading-tight">
              {project?.description}
            </div>
          </div>
        </div>
          ...
          <div className="justify-start items-center gap-2.5 inline-flex">
                ...
                <div data-svg-wrapper className="relative">
                  <svg
                    ...
                    <path
                      ...
                      stroke-linejoin="round" />
                    <path
                      d="M2.83301 12.2432C2.83301 7.88594 2.83301 5.70728 4.08513 4.35364C5.33725 3 7.3525 3 11.383 3H13.283C17.3135 3 19.3288 3 20.5809 4.35364C21.833 5.70728 21.833 7.88594 21.833 12.2432V12.7568C21.833 17.1141 21.833 19.2927 20.5809 20.6464C19.3288 22 17.3135 22 13.283 22H11.383C7.3525 22 5.33725 22 4.08513 20.6464C2.83301 19.2927 2.83301 17.1141 2.83301 12.7568V12.2432Z"
                      stroke="#141B34"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round" />
            ...
            <div className="grow shrink basis-0 justify-center items-center gap-4 flex">
              <div className="grow shrink basis-0 justify-start items-start gap-2.5 flex">
                ...
                <div
                  className="grow shrink basis-0 flex-col justify-center items-start gap-1 inline-flex">
          ...
          <div className="justify-center items-center gap-1 inline-flex">
            {
              project?.skills.length ? project.skills.map((skill, index) => {
                return (
                  <div
                    key={`skill-${index}`}
                    className="px-2 py-1 bg-gray-200 rounded-2xl justify-center items-center gap-2.5 flex overflow-hidden">
      ...
      <div
        className="w-[360px] pl-9 py-6 border-l border-gray-200 flex-col justify-start items-start gap-6 inline-flex">
        <div className="self-stretch flex-col justify-center items-start gap-5 flex">
          <button
            className="justify-center items-center gap-2.5 inline-flex hover:text-green500 stroke-black hover:stroke-green500 transition-all">
            <div data-svg-wrapper className="relative">
              <svg
                width="24"
                height="24"
            ...
            <div data-svg-wrapper className="relative">
              <svg
                ...
                <path
                  ...
                  stroke-linejoin="round" />
                <path
                  d="M17.7812 16.6953L17.7885 16.6934"
                  stroke-width="1.66667"
                  stroke-linecap="round"
                  stroke-linejoin="round" />
                <path
        ...
        <div className="flex-col justify-start items-start gap-2.5 flex">
          ...
          <div className="flex-col justify-center items-start gap-2.5 flex">
            <div
              className="p-4 bg-gray-200 rounded justify-center items-center gap-2.5 inline-flex overflow-hidden">
              <div className="text-gray-700 text-base font-medium">https://www.upwork.com/jobs/24659...</div>
            </div>
            <button
              className="text-emerald-500 text-base font-medium hover:underline transition-all">Copy link</button>
          </div>
        </div>
      </div>
    </div>
