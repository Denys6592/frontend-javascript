  ...
  return (
    <div className="flex flex-col gap-2.5 p-5 border-b border-gray200">
      <div className="flex justify-between gap-5">
        <div className="flex gap-2.5">
          <div className="relative">
            <Image
              ...
              height={50} />
            <div
              className={`absolute top-1 left-1 w-2 h-2 border border-white rounded-full ${
                online ? "bg-green400" : "bg-gray500"
              }`} />
        ...
        <div className="flex items-center gap-2.5">
          <div
            ...
            className={`flex justify-center items-center w-10 h-10 rounded-full top-4 right-4 border border-green500 transition-transform duration-300 ease-in-out transform hover:scale-110 cursor-pointer ${
      ...
      <div className="flex gap-5 text-gray400">
          ...
          <div className="flex items-center gap-1">
            <svg
              ...
              <mask id="path-3-inside-1_3326_1188" fill="white">
                <path
                  d="M8 9.53674e-07C9.7539 9.53674e-07 11.4592 0.576385 12.8535 1.64045C14.2477 2.70451 15.2537 4.19728 15.7165 5.88902C16.1793 7.58076 16.0733 9.37771 15.4149 11.0033C14.7564 12.6289 13.582 13.9931 12.0723 14.8859C10.5627 15.7787 8.80145 16.1507 7.0597 15.9445C5.31795 15.7384 3.69222 14.9656 2.4327 13.745C1.17317 12.5244 0.349664 10.9238 0.0889078 9.18938C-0.171849 7.45497 0.144598 5.68293 0.989547 4.14597L8 8L8 9.53674e-07Z" />
              </mask>
              <circle
                cx="8"
                cy="8"
        ...
        {available && (
          <div
            className="flex items-center px-2 py-1 gap-1 text-[10px] text-blue400 border border-blue400 rounded-full">
            <Icons.available />
            Available now
          </div>
        )}
      ...
      <p className="leading-xs text-black leading-tight">{description}</p>
      <p className="mt-2 text-gray600 line-clamp-3">
        {" "}
        {/* Added proposal section */}
        <strong>Proposal:</strong> {proposalText}
      </p>
    </div>
  );
};
