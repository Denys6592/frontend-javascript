...
const SetProfile = () => {
  ...
  const formikSecondStep = useFormik({
    ...
    validationSchema: Yup.object({
      workHistory: Yup.array().of(Yup.object().shape({
        ...
        <div className="w-full p-10 flex flex-col items-start">
          ...
          <div className="w-full flex flex-col items-center justify-center">
            <div className="max-w-[514px] w-full flex flex-col gap-5 pb-[50px]">
              ...
              {step === 1 && (
                <SecondStep user={user} setUser={setUser} formik={formikSecondStep} />
              )}
              {step === 2 && (
                <ThirdStep user={user} setUser={setUser} formik={formikThirdStep} />
              )}
              <GradientButton
