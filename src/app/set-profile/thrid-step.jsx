...
const ThirdStep = ({ user, setUser, formik }) => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div
        className="w-full pb-5 items-center justify-between border-b border-[#0302290e]">
        ...
        portfolioLinks.map((link, index) => (
          <div key={index} className="mt-3 w-full flex items-center">
            <Input
              ...
              value={link} />
            <button className="ml-2 text-red-600" onClick={() => removePortfolioLink(index)}>
