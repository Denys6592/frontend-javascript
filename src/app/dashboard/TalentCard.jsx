...
const TalentCard = () => {
    ...
    return (
        <div
            className="w-full p-4 rounded-lg border border-gray-200 flex-col justify-start items-start gap-2.5 flex">
            <div className="w-full justify-start items-start gap-2.5 flex">
                <div className="relative w-10 h-10">
                    ...
                    <div
                        className="absolute bottom-0.5 right-0.5 w-2 h-2 rounded-full bg-green500" />
                </div>
                ...
                <button
                    ...
                    className={`w-6 h-6 flex justify-center items-center border rounded-full transition-all hover:border-green500 hover:text-green500 ${isFav ? "border-green500 text-green500" : "border-gray500 text-gray500"}`}>
                    {
            ...
            <div className="w-full justify-start items-center gap-1 flex flex-wrap">
                <div
                    className="px-3 py-2 bg-[#007dfc] rounded-2xl flex-col justify-start items-start gap-2 flex overflow-hidden hover:shadow transition-all cursor-pointer">
            ...
            <div className="w-full justify-start items-center gap-1 flex">
                <div
                    className="px-3 py-2 bg-[#aeaeae] rounded-2xl justify-start items-start gap-0.5 flex overflow-hidden">
            ...
            <InviteModal
                open={open}
                onClose={handleClose}
                talent={{ name: 'Louis S.', role: 'Full Stack Developer' }} />
        </div>
    );
};
