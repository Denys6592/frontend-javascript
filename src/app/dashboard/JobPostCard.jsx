...
const JobPostCard = ({ project: any }) => {
    ...
    return (
        <div
            className="flex-1 p-4 min-h-60 rounded-lg border border-gray-200 flex-col justify-start gap-2.5 flex">
            ...
            <div className="w-full justify-start items-center gap-2.5 flex">
                <div
                    className="px-2 py-1 bg-[#007dfc] rounded flex-col justify-start items-start gap-2 flex overflow-hidden">
