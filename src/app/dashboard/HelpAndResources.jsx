const HelpAndResources = () => {
  return (
    <div className="w-full flex-col justify-start items-start gap-4 flex">
      ...
      <div
        className="w-full p-6 rounded-lg border border-gray-200 flex-col justify-center items-start gap-2.5 flex overflow-hidden">
        <div className="text-gray-500 text-base font-semibold">Get started</div>
        <div className="text-black text-2xl font-semibold">
          Get started and connect with talent to get work done
        </div>
        <div
          className="px-4 py-2 rounded-lg border border-gray-200 justify-center items-center gap-2.5 flex">
