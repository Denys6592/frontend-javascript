  ...
  return (
    <div className="flex px-4 py-5 gap-4 bg-gray200 rounded-2xl">
      ...
      <div className="flex flex-col gap-2 basis-1/5">
        <button
          className="flex h-10 justify-center items-center text-sm text-white bg-black rounded hover:bg-gray-800 transition-colors duration-300">
          Add time manually
        </button>
        <button
          className="flex h-10 justify-center items-center text-sm border border-black rounded hover:bg-black hover:text-white transition-colors duration-300">
          View timesheet
        </button>
      </div>
    </div>
