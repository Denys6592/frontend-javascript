...
const SignUp = () => {
  ...
  return (
    <div
      className="relative w-screen h-screen overflow-hidden flex items-center justify-center bg-gradient-to-r from-[#D8E5EE] to-[#EED4E9]">
      <div className="w-[1080px] bg-white rounded-lg flex">
        {role && step === 2 ? (
          <>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-center gap-1">
                      ...
                      <div className="group relative leading-none">
                        ...
                        <span
                          className="absolute left-0 bottom-0 h-[1px] w-full bg-gradient-to-r from-gradientStart to-gradientEnd group-hover:!bg-blue500 transition-all"></span>
                      </div>
                    </div>
                  </div>
                </form>
            ...
            <div
              className="w-full flex items-center justify-center bg-gradient-to-r from-[#198BD81c] to-[#F03DCE1c] rounded-e-lg">
              <Image src="/image/auth-logo.svg" alt="auth logo" width={430} height={379} />
            </div>
          </>
        ) : (
          <div className="flex flex-col w-full gap-10 p-10">
            ...
            <div className="flex justify-center gap-5">
              <div
                ...
                <div
                  className="relative flex flex-col items-center w-full h-full px-5 py-10 rounded-xl bg-white gap-3">
                  <Icons.freelancer />
            ...
            <div className="flex flex-col gap-3 items-center">
              ...
              <div className="group relative text-xs text-context text-center">
                ...
                <Link href="/sign-in">
                  <span
                    className="bg-clip-text cursor-pointer group-hover:text-blue500 underline transition-all">
                    Terms of Use
                  </span>
                </Link>
