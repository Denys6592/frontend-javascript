...
const SummarySection = () => {
  ...
  return (
    <div
      className="flex flex-col gap-8 bg-white -mt-24 px-8 py-10 rounded-2xl shadow">
      ...
      <button
        className="w-full py-3 bg-gradient-to-r from-blue500 to-pink-500 text-white font-semibold rounded-lg hover:drop-shadow-lg transition-all">
        Start Subscription
      </button>
    </div>
  );
