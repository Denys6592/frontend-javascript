...
const SearchBar = ({
  ...
  return (
    <div className="w-full bg-white px-10 rounded-b-[20px]">
      <div
        className="flex items-center border-t-[1px] gap-6 py-7 bg-white justify-center w-[full] m-auto">
        <div
          className="flex items-center gap-2 flex-1 bg-gray100 px-3 py-2 rounded-md border border-solid border-gray100 outline-none focus-within:ring hover:ring focus-within:border-blue300 hover:border-blue300 transition-all">
        ...
        <Dropdown
          items={[
            ...
            { id: 2, label: "Saudi Arabia", slug: "KSA" },
          ...
          icon={
            <div
              className="flex items-center justify-center p-2.5 rounded-full border border-gray200">
