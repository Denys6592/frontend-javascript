    ...
    <Collapsible title="Assigned to me">
      <div className="flex justify-between items-start">
        <div className="flex items-center gap-2">
          <button
            className="px-2 py-1 rounded-lg border border-gray-500 hover:bg-gray-200 transition-colors flex items-center gap-1">
          ...
          <button
            ...
            <div data-svg-wrapper className="relative">
              <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                ...
                <path d="M3.54166 1.042V8.95866" stroke="#6B7280" strokeWidth="0.625" />
                <path d="M6.45834 1.042V8.95866" stroke="#6B7280" strokeWidth="0.625" />
              </svg>
            </div>
            <div className="text-gray-500 text-[10px]">Columns</div>
          </button>
          <button
            className="px-2 py-1 rounded border border-gray-500 hover:bg-gray-200 transition-colors">
      ...
      <div className="flex flex-col gap-4 w-full mt-4">
        <Collapsible title="In Progress">
          ...
          <div className="pl-6 flex flex-col gap-1">
            ...
            <div
              className="px-2 pt-2 pb-1 border-b border-gray-200 flex justify-between items-center">
              <TaskRow
                title="Website Responsive"
                project="The Freelancer Project"
                date="2025/02/12" />
