...
const Header = ({
  ...
  return (
    <div
      className="flex flex-col bg-gray100 gap-4 sm:gap-8 px-2 sm:px-4 py-3 sm:py-5">
      <div
        className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-4 sm:gap-0">
        <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
          <span
            className="text-xl sm:text-2xl md:text-4xl font-medium text-black break-words">
          ...
          <div className="flex items-center -space-x-2">
            ...
            {tmUsers && tmUsers?.length > 5 ? (
              <div
                className="relative w-6 h-6 sm:w-8 sm:h-8 rounded-full border border-black">
                <Image
                  className="w-6 h-6 sm:w-8 sm:h-8 rounded-full border border-black"
                  ...
                  alt="User" />
                <div
                  className="absolute w-full h-full top-0 left-0 bg-black opacity-50 rounded-full" />
                <span
                  className="absolute top-1/2 left-1/2 text-white text-xs -translate-x-1/2 -translate-y-1/2">
                  +{tmUsers.length - 5}
                </span>
              </div>
            ) : (
      ...
      <div
        ...
        <button
          className="w-8 h-8 sm:w-10 sm:h-10 text-gray500 bg-white rounded-lg px-1.5 sm:px-2 py-1.5 sm:py-2 flex justify-center items-center hover:shadow transition-all">
