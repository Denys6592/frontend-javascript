import { Avatar, Box, Button, MenuItem, Modal, Select, Switch } from "@mui/material";
...
import { apiUrl, priorities } from "@/utils/constant";
...
const TaskDetailModal = ({
  ...
  const [selectedProject, setSelectedProject] = useState(tmProject || null);
  ...
  const [selectedPriority, setSelectedPriority] = useState(task && task.priority ? task.priority : "");
  const [selectedDate, setSelectedDate] = useState(task && task.dueDate ? dayjs(task.dueDate) : null);
  ...
  useEffect(() => {
    ...
    if (task?.assignee) {
      ...
      const selectedUser = members.find((member) => member.user._id === assigneeId);
  ...
  const handleChangeProject = (event) => {
    ...
    const selectedProject1 = tmProjects.find((project) => project._id === selectedProjectId);
    if (selectedProject1) setSelectedProject(selectedProject1);
  };

  const handleChangeLead = (event) => {
    const selectedUserId = event.target.value;
    const selectedUser = members.find((member) => member.user._id === selectedUserId);
    ...
    <Modal
      ...
      <Box sx={style} className="flex flex-col">
        {task && (
          <>
            <div
              className="flex justify-between items-center pl-4 sm:pl-8 pr-4 sm:pr-6 pt-4 sm:pt-5 pb-3 rounded-t-[20px] border-b border-gray400">
              {" "}
            ...
            <div
              className="flex flex-col md:flex-row rounded-b-[20px] max-h-[calc(90vh-70px)] overflow-auto">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-2">
                    ...
                    <div className="flex flex-col sm:basis-1/2 gap-2">
                      ...
                      <Select
                        ...
                        fullWidth>
                        {members.map((lead) => (
                          <MenuItem key={lead.user.fullName} value={lead.user._id}>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-2">
                    ...
                    <div className="flex flex-col sm:basis-1/2 gap-2">
                      ...
                      <Select
                        ...
                        fullWidth>
                        {members.map((member) => (
                          <MenuItem key={member.user.fullName} value={member.user._id}>
                            <div className="flex items-center gap-2">
                              <Avatar
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div
                      ...
                      <input type="file" multiple onChange={handleFileChange} className="max-w-full" />
                  ...
                  <div
                    className="flex items-center border border-gray400 rounded-lg p-2.5 gap-5">
              ...
              <div
                ...
                <div className="flex justify-between items-center">
                  <div className="flex-1">
                    <div
                      className="flex items-center justify-between px-4 py-3 border-b border-gray400 gap-2.5 bg-white">
                ...
                <div className="flex flex-1">
                  <div className="flex-1 flex flex-col border-r border-gray400">
                    <div className="flex flex-col gap-2 p-4 flex-1">
                      <div className="flex-1 flex flex-col gap-2.5">
                        ...
                        {[1, 2, 3].map((index) => (
                          <div
                            ...
                            <div className="w-6">
                              <Image src="/image/avatar/1.jpg" alt="User Avatar" width={24} height={24} />
                            </div>
                            <div className="flex-1 flex flex-col gap-1">
                              ...
                              <div className="flex justify-between gap-5">
                                ...
                                <div className="flex-1 justify-start">
                                  <button
                                    className="flex items-center gap-1.5 text-xs text-blue400 hover:text-blue500 transition-all">
                                    <span>5</span>
                                    <FaThumbsUp />
                                  </button>
                                </div>
                      ...
                      {/* Comment Box */}
                      <div
                        className="flex flex-col px-2.5 py-1.5 border border-gray300 rounded gap-2.5 bg-white">
                        <textarea
                        ...
                        <div className="flex justify-between">
                          ...
                          <button
                            className="flex justify-center items-center w-16 h-6 text-sm text-white bg-blue400 rounded hover:bg-blue500 hover:shadow-sm transition-all">
                            Send
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="hidden sm:flex flex-col gap-4 w-14 p-2.5">
                    ...
                    <hr />
                    <button
                      className="group flex justify-center items-center hover:bg-green200 w-9 h-9 rounded transition-all">
                      <svg
                        width="28"
                        height="28"
                        viewBox="0 0 28 28"
