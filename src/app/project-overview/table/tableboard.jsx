...
(function(Priroty) {
  Priroty["urgent"] = "Urgent";
  Priroty["high"] = "High";
  Priroty["medium"] = "Medium";
  Priroty["low"] = "Low";
})(Priroty || (Priroty = {}));
...
const TableBoard = ({ tmTasks, setTmTasks, tmProjects, tmProject }) => {
                          ...
                          <div className="flex items-center gap-1">
                            <div className="">
                              <svg
                                ...
                                <path d="M3 15.75V6" stroke="#FF0000" strokeWidth="1.5" strokeLinecap="round" />
                              </svg>
                            </div>
                            ...
                            <div className="">
                              <svg
                                ...
                                <path
                                  ...
                                  strokeLinecap="round"
                                  strokeLinejoin="round" />
                                <path d="M3 15.75V6" stroke="#FF5733" strokeWidth="1.5" strokeLinecap="round" />
                              </svg>
                            </div>
                            <div className="text-red500 text-xs font-medium">
                              {task.priority}
                            ...
                            <div className="">
                              <svg
                                ...
                                <path
                                  ...
                                  strokeLinecap="round"
                                  strokeLinejoin="round" />
                                <path d="M3 15.75V6" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" />
                              </svg>
                            </div>
                            ...
                            <div className="">
                              <svg
                                ...
                                <path
                                  ...
                                  strokeLinecap="round"
                                  strokeLinejoin="round" />
                                <path d="M3 15.75V6" stroke="#9CA3AF" strokeWidth="1.5" strokeLinecap="round" />
                              </svg>
                            </div>
