        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="flex flex-col gap-8 px-5 py-8 bg-white shadow-md rounded-2xl">
            ...
            <div className="flex gap-2.5">
              <button
                className="flex w-60 justify-center items-center gap-2 px-4 py-2 bg-black text-white rounded">
                Send
            ...
            <div className="">
              ...
              <div className="bg-gray200 rounded-full h-2.5 mt-2">
                <div className="bg-[#10B981] h-2.5 rounded-full" style={{ width: "60%" }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between p-5 border rounded-2xl">
            ...
            <div
              className="flex items-center bg-gradient-to-r from-blue100 to-purple-100 rounded-lg p-4 shadow-sm">
              ...
              <div className="text-gray-700">
                ...
                <a href="/find-job" className="font-medium text-context underline">
                  Search jobs
                </a>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div
              className="relative flex w-80 p-2 gap-2 items-center border rounded-md text-gray500 bg-white outline-none focus-within:ring hover:ring focus-within:border-blue300 hover:border-blue300 transition-all">
            ...
            <button
              className="flex w-40 justify-center px-4 py-2 border border-black rounded text-context text-sm hover:bg-black hover:text-white transition-all">
              Download CSV
            </button>
          </div>
        </div>
