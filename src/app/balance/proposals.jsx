    ...
    <div className="flex flex-col gap-1">
      <div className="flex items-center">
        ...
        <div className="w-full bg-gray200 rounded-full h-3">
          <div className="bg-[#A78BFA] h-3 rounded-r-full" style={{ width: "80%" }}></div>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="w-full bg-gray200 rounded-full h-3">
          <div className="bg-[#A78BFA] h-3 rounded-r-full" style={{ width: "60%" }}></div>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="w-full bg-gray200 rounded-full h-3">
          <div className="bg-[#A78BFA] h-3 rounded-r-full" style={{ width: "40%" }}></div>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="w-full bg-gray200 rounded-full h-3">
          <div className="bg-[#A78BFA] h-3 rounded-r-full" style={{ width: "30%" }}></div>
        </div>
      </div>
    </div>
  );
