...
export default function ForgotPassword() {
  ...
  return (
    <div
      ...
      <div
        className="bg-white rounded-lg shadow-md max-w-xl px-12 py-20 flex flex-col gap-12 w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="text-center">
              <div className="h-4">
                <Link href="/sign-in" className="forgot-password-link hover:underline">
