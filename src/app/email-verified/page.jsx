...
const EmailVerified = () => {
    ...
    return (
        <div
            ...
            <div
                className="bg-white w-full max-w-lg rounded-lg flex items-center m-4 sm:m-8">
                <div
                    className="px-6 py-8 sm:px-8 sm:py-12 flex flex-col items-center justify-center text-center">
