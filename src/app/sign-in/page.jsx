  ...
  return (
    <div
      ...
      <div className="w-[1080px] bg-white rounded-lg flex">
          ...
          <div className="flex flex-col gap-4">
            ...
            <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
              <div className="flex flex-col gap-4">
                ...
                <Link href="/forgot-password" className="text-base text-end hover:underline">
                  Forgot password?
                </Link>
              </div>
        ...
        <div
          className="w-full flex items-center justify-center bg-gradient-to-r from-[#198cd81c] to-[#f03dcf1c] rounded-e-lg">
          <Image src="/image/auth-logo.svg" alt="auth logo" width={495} height={461} />
        </div>
      </div>
    </div>
  );
