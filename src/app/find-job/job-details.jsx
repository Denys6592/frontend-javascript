      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-2 justify-end flex-wrap">
            {["Part time", "Senior level", "Distant", "Project work"].map((tag) => (
              <span
                key={tag}
          ...
          <div className="flex justify-end">
            <div
              className="group p-[1px] rounded-md bg-gradient-to-r from-purple-500 to-blue500">
              <button
                className="flex items-center justify-center gap-2 px-4 py-2 bg-white rounded-md w-full h-full stroke-context group-hover:bg-transparent group-hover:text-white group-hover:stroke-white transition-all">
