    ...
    <div className="flex flex-col items-center gap-5 pt-4">
      <div className="flex justify-between w-full max-w-[1480px] px-5">
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div
              className="absolute right-0 mt-1 w-[200px] bg-white border border-gray200 rounded-lg shadow-lg z-10">
              <ul className="py-2.5">
                <li
      ...
      <div className="flex items-center gap-2.5 w-full max-w-[1480px] px-5">
        <div className="relative w-[50px] h-[50px]">
          ...
          <div
            className="absolute w-2.5 h-2.5 top-[3px] left-[3px] border border-blue400 bg-green500 rounded-full" />
        </div>
