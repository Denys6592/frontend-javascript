    ...
    <Draggable draggableId={`task-${task.id}`} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          <button
            className="flex justify-center items-center w-6 h-6 hover:bg-gray200 rounded transition-colors">
          ...
          <div
            className="flex gap-2.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
            <button
