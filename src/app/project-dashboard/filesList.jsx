    ...
    <div className="flex flex-col max-w-[340px]">
      <div className="p-5 gap-5 rounded-xl border border-gray400">
        <div className="flex items-center gap-2.5">
          ...
          <button
            className="flex items-center justify-center w-6 h-6 border border-gray400 rounded-full hover:bg-gray200 transition-all">
            <FiRefreshCcw className="w-3 h-3" />
          </button>
          <label
            className="px-2.5 py-1 text-sm border rounded-lg border-gray400 hover:bg-gray200 transition-all cursor-pointer">
            Upload
            ...
            <ul className="flex flex-col list-disc pl-2 gap-4">
              {files.map((file, index) => (
                <li key={index} className="flex items-center gap-2">
                  ...
                  <div
                    className="flex-1 text-context text-ellipsis overflow-hidden whitespace-nowrap">
                    {file.name}
                  </div>
                </li>
              ))}
