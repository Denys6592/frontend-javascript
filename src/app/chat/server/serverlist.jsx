...
import { chatServerAtom, ServerFlag } from "@/store/auth";
...
const ServerList = () => {
  ...
  const handleServer = (type, ide, name, imageUrl) => {
    setServer({
  ...
  return (
    <div className="flex flex-col w-20 !h-[80vh]">
        ...
        {serverList.map((item, key) => (
          <button
            ...
            <Image
              ...
              src="http://localhost:8000/uploads/1745892593618.jpg" />
          </button>
        ))}
      </div>
      ...
      <button
        ...
        <div
          className="flex justify-center items-center gap-2.5 bg-gray-100 rounded-lg w-10 h-10">
          <Icons.city_1 />
        </div>
      </button>
    </div>
