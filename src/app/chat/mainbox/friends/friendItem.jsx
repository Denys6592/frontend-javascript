...
const FriendItem = ({
  ...
  const setAccept = async (requestId) => {
  ...
  const setCancel = async (requestId) => {
  ...
  return (
    <div
      className="inline-flex relative z-1 justify-start items-center gap-2.5 border-gray-100 p-2.5 border-t hover:cursor-pointer self-stretch">
      <Image
        ...
        src={avatar} />
      <div
        className="font-medium text-gray-500 text-sm leading-normal basis-0 grow shrink">
        {name}
      </div>
      ...
      <div
        ...
        <div
          className="flex flex-col justify-start items-start bg-white h-[114px] overflow-hidden self-stretch">
          <button
            className="inline-flex justify-start items-center gap-2.5 hover:bg-gray-200 py-1.5 overflow-hidden self-stretch">
            <div
              className="font-normal text-gray-700 text-xs leading-none basis-0 grow shrink">
              Start Video Call
            </div>
          </button>
          <button
