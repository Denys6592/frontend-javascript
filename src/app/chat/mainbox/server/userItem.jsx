  ...
  return (
    <button
      ...
      <div className="relative flex justify-start items-center gap-2.5 w-10 h-10">
        ...
        <div
          className="top-8 right-0 absolute bg-emerald-500 border border-white rounded-full w-2 h-2" />
      </div>
      <div
        ...
        <div className="inline-flex justify-start items-center self-stretch gap-2">
          <div
            className="font-['DM font-semibold text-[#171718] text-base leading-normal Sans']">
            Ralph Edwards
          </div>
        </div>
      </div>
