...
const Profile = () => {
  ...
  return (
    <div
      className="inline-flex flex-col items-center gap-2.5 bg-white border-gray-100 border-l w-80 max-h-[calc(100vh-200px)] overflow-y-auto hide-scrollbar">
      <div
        className="inline-flex relative justify-start items-start self-stretch gap-2.5 bg-white p-5 border-gray-100 border-b border-l">
        <div
          className="font-semibold text-[#171718] text-xl leading-tight basis-0 grow shrink">
          Profile
        </div>
        <button
          onClick={() => {
        ...
        <div
          ...
          <div
            className="flex flex-col justify-start items-start self-stretch bg-white h-[114px] overflow-hidden">
            <button
              className="inline-flex justify-start items-center self-stretch gap-2.5 px-2.5 py-2 overflow-hidden">
              <div
                className="flex font-normal text-gray-700 text-xs leading-none basis-0 grow shrink">
                Invite to Server
              </div>
              <Icons.arrow_right />
            </button>
            ...
            <button
              ...
              <div
                className="flex font-normal text-red-500 text-xs leading-none basis-0 grow shrink">
                Block
              </div>
            </button>
            <button
      ...
      <div className="flex flex-col justify-start self-stretch px-5 h-[75px]">
        <div
          className="font-extrabold text-[#171718] text-lg text-center leading-normal tracking-tight">
          {selector.name}
        </div>
        <div
          className="font-medium text-gray-500 text-sm text-center leading-[21px] tracking-tight">
          {selector.role}
        </div>
      ...
      <div className="self-stretch bg-gray-100 h-px" />
      <div
        className="flex flex-col justify-start items-start self-stretch gap-2.5 px-5 h-[108px]">
        <div className="inline-flex justify-start items-center self-stretch gap-3">
          <div
            className="font-semibold text-[#171718] text-base leading-normal basis-0 grow shrink">
            Contact information
          </div>
        </div>
        <div
          className="flex flex-col justify-start items-start self-stretch gap-2.5 h-[74px]">
          <div className="inline-flex justify-start items-center self-stretch gap-2.5">
            <div
              className="flex justify-center items-center gap-2.5 bg-gray-100 rounded w-6 h-6">
              <Icons.mail_1 />
            </div>
            <div
              className="inline-flex flex-col justify-start items-start basis-0 grow shrink">
              <div
                className="self-stretch font-semibold text-[#171718] text-xs leading-none">
                Email Verified
              </div>
      ...
      <div className="self-stretch bg-gray-100 h-px" />
      <div
        className="flex flex-col justify-start items-start self-stretch gap-2.5 px-5 h-[334px]">
        <div className="inline-flex justify-start items-center self-stretch">
          <button
            ...
            <div
              className="font-semibold text-[#171718] text-base text-center leading-normal basis-0 grow shrink">
              Media
            </div>
          </button>
        ...
        <div
          className="flex flex-col justify-start items-start self-stretch gap-2.5 h-[250px]">
          {tab === "media" && (
            <>
              ...
              <div className="inline-flex justify-start items-start self-stretch gap-2.5">
                ...
                <div className="relative h-[120px] overflow-hidden">
                  ...
                  <div
                    className="top-[43px] left-[50px] absolute font-semibold text-white text-2xl text-center leading-loose">
                    12+
                  </div>
                </div>
              </div>
          ...
          {tab === "groups" && (
            <>
              <button
                className="inline-flex justify-start items-center self-stretch gap-2.5 bg-gray-100 px-5 py-3.5 border-l-2">
                ...
                <div
                  className="inline-flex flex-col justify-start items-start gap-1 basis-0 grow shrink">
