...
const ReportModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="z-50 fixed inset-0 flex justify-center items-center">
      <div
        className="inline-flex flex-col justify-start items-start gap-2.5 bg-white px-5 py-[30px] rounded-[20px] w-[640px] h-[495px]">
        <div
          className="flex flex-col justify-start items-start gap-5 bg-white h-[435px] self-stretch">
          <div
            className="flex flex-col justify-start items-start gap-5 h-11 self-stretch">
            <div className="inline-flex justify-between items-center self-stretch">
              <div
                className="flex justify-start items-center gap-2.5 h-[17px] basis-0 grow shrink">
                <div
                  className="font-semibold text-[#171718] text-2xl leading-[28.80px] basis-0 grow shrink">
                  Report User
                </div>
              </div>
          ...
          <div
            className="flex flex-col justify-start items-start gap-2.5 h-[61px] self-stretch">
            <div
              className="font-medium text-[#171718] text-base leading-tight self-stretch">
              Reason
            </div>
          ...
          <div
            ...
            <div className="flex flex-col justify-start items-start h-10 self-stretch">
              <div
                className="inline-flex justify-start items-center gap-2.5 border-gray-200 p-2.5 border rounded-[10px] h-10 overflow-hidden self-stretch">
                <Image width={24} height={24} alt="avatar" src={selector.avatar} />
