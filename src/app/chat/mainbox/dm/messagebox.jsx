...
const MessageBox = ({ sidebar, setSidebar }) => {
  ...
  const [messageList, setMessageList] = useState([]); // State to hold messages
  ...
  return (
    <div className="flex flex-col flex-1 w-150">
      <div
        className="flex justify-start items-center self-stretch gap-3 bg-white p-5 border-[#f3f3f3] border-b overflow-hidden">
        <Image
          width={48}
          height={48}
          alt="user"
        ...
        <div
          ...
          <div
            className="self-stretch font-semibold text-[#202226] text-base leading-normal tracking-tight">
            {selector.name}
          </div>
          <div
            className="font-medium text-emerald-500 text-xs leading-[18px] tracking-wide">
            Online
          </div>
        </div>
      ...
      <div
        className="flex-col justify-end items-center self-stretch gap-2.5 bg-gray-100 mb-4 p-5 h-[60vh] overflow-auto hide-scrollbar basis-0 grow">
            ...
            msg.senderId === user?.uid ? (
              <div
                ...
                <div
                  ...
                  <div
                    className="inline-flex justify-start items-start self-stretch gap-2.5 p-2.5 rounded-tr-2xl rounded-bl-2xl rounded-br-2xl overflow-hidden text-bold">
                    <div
                      className="inline-flex flex-col justify-center items-end gap-1 basis-0 grow shrink">
                      <div
                      ...
                      {msg.files &&
                        ...
                        msg.files.map((file, fileIndex) => (
                          <div
                            ...
                            key={fileIndex}>
                            <div
                              className="inline-flex justify-start items-center gap-2.5 bg-[#dce8f6] p-2.5 border rounded-xl h-20">
                              {getFileIcon(file)}
                              ...
                              <div
                                className="flex justify-center items-center gap-2.5 bg-white px-0.5 py-2 border rounded-[10px] w-[36.47px] h-10">
      ...
      <div
        className="flex flex-col justify-start items-start self-stretch gap-2 bg-white mb-2.5 px-5 w-full">
        ...
        <div
          className="inline-flex items-start self-stretch bg-gray-100 px-3 py-1 rounded-lg relative">
          ...
          <div className="flex-1 bg-gray-100 border-gray-200 rounded-lg">
            ...
            {previews.length > 0 && (
              <div
                className="flex gap-4 p-[14px] border-b border-gray-300 max-w-[630px] overflow-x-auto">
                {previews.map((file, index) => (
                  <div key={index} className="relative border p-2 rounded-lg bg-gray-100 w-40">
                    {file.type === "image" ? (
                      <>
                        <Image
                          src={file.url}
            ...
            <TextField
              ...
              inputRef={inputRef}
              value={message}
              onChange={(e) => { handleTyping(e); setMessage(e.target.value); }}
          ...
          {showEmojis && (
            <div
              className="top-[-180px] absolute gap-2 grid grid-cols-5 bg-white shadow-md p-2 border rounded-lg max-h-48 overflow-y-auto hide-scrollbar">
              {emojis.map((emoji) => (
                <button
                  key={emoji}
      ...
      <SettingModel isOpen={isSettingOpen} onClose={() => setIsSettingOpen(false)} />
    </div>
  );
};
