...
const Setting = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="z-50 fixed inset-0 flex justify-center items-center">
      ...
      <div
        className="z-10 flex flex-col gap-5 bg-white shadow-lg p-5 rounded-lg w-full max-w-xl">
        ...
        <div className="flex flex-col gap-2.5">
          <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} />} label="Open threads in split view" />
        </div>
