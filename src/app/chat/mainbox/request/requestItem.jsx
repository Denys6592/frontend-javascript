...
const RequestItem = () => {
  ...
  return (
    <div className="flex flex-col justify-start items-start self-stretch">
      <div
        className="inline-flex justify-start items-center gap-2.5 border-gray-100 p-2.5 border-t self-stretch">
        <Image
          width={32}
          height={32}
          alt="avatar"
        ...
        <div
          ...
          <div className="inline-flex justify-start items-center gap-1 self-stretch">
            ...
            <div
              className="font-medium text-gray-500 text-xs leading-3 basis-0 grow shrink">
              26d ago
            </div>
          </div>
          <div className="inline-flex justify-start items-center gap-1 self-stretch">
        ...
        <button
          className="flex justify-center items-center gap-2.5 bg-red-500 px-2.5 py-2 rounded">
          <div className="font-medium text-[10px] text-white leading-[10px]">
            Report
          </div>
        </button>
