...
const UserItem = ({ avatar, name, id, timezone, newMessages }) => {
    ...
    <div className="relative self-stretch">
      <button
        ...
        <div className="relative flex justify-start items-center gap-2.5 h-12">
          <Image width={48} height={48} alt="avatar" className="rounded-3xl" src={avatar} />
          <div
        ...
        <div
          ...
          <div className="inline-flex justify-end items-start self-stretch gap-1">
            ...
            </div> */}
            {
              newMessages > 0 &&
                <div
                  className="inline-flex flex-col justify-center items-center gap-2 bg-emerald-500 px-2 py-1 rounded-[50px] w-5 h-5">
                  <div
                    className="font-['Plus font-medium text-white text-xs text-center leading-tight Jakarta">
                    {newMessages}
                  </div>
                </div>
            }
