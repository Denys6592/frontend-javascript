...
const InviteModel = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="z-50 fixed inset-0 flex justify-center items-center">
      ...
      <div
        className="z-10 flex flex-col gap-5 bg-white shadow-lg p-5 rounded-lg w-full max-w-2xl">
        ...
        <div className="flex flex-col gap-2.5">
          <div className="flex flex-col justify-start items-start self-stretch">
            <div
              className="inline-flex justify-start items-center self-stretch gap-2.5 p-2.5 border-gray-100 border-t">
              <Image
                width={32}
                height={32}
                alt="avatar"
