    ...
    <div className="z-50 fixed inset-0 flex justify-center items-center">
      ...
      <div
        ...
        <div className="flex flex-col gap-2.5">
          <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} />} label="Mute Channel" />
        </div>
        ...
        <div className="flex flex-col gap-2.5">
          <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} />} label="Suppress All Role @Mentions" />
        </div>

        <div className="flex flex-col gap-2.5">
          <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} />} label="Suppress Highlights" />
        </div>
