...
const BlockModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="z-50 fixed inset-0 flex justify-center items-center">
      ...
      <div
        className="z-10 flex flex-col gap-5 bg-white shadow-lg p-5 rounded-lg max-w-2xl">
        <div className="flex justify-between gap-4">
          <h2 className="font-semibold text-xl">Block this user?</h2>
          <button
        ...
        <div className="flex items-center gap-2.5 bg-gray100 p-2.5 rounded-lg h-10">
          <Icons.lightbulbon />
          <div className="text-gray500 text-sm">
              Limit access to your profile and activity
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 bg-gray100 p-2.5 rounded-lg h-10">
          <Icons.lightbulbon />
          <div className="text-gray500 text-sm">
              They can interact with you in GDMs and servers
          </div>
        </div>        

        <div className="flex flex-col gap-2.5">
          <button
            className="bg-red-500 hover:bg-red-600 hover:shadow-lg mx-4 px-4 py-2 rounded-lg min-w-24 text-white transition-all duration-200"
            onClick={onClose}>
            Block
          </button>
        </div>
