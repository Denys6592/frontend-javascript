...
const Community = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div
        className="inline-flex flex-col justify-center items-start gap-3 bg-white px-[230px] py-5 border-[#f3f3f3] border-b h-[132px] overflow-hidden">
        <div className="inline-flex justify-start items-center self-stretch gap-3">
          <div
            className="inline-flex flex-col justify-center items-start gap-2 grow shrink basis-0">
            <div
              className="font-['DM font-semibold text-black text-base leading-tight Sans']">
          ...
          <button
            ...
            <div
              className="font-['DM font-medium text-white text-sm leading-normal Sans']">
              Create Server
            </div>
          </button>
        </div>
      ...
      <div className="px-[230px] py-5">
        <div
          className="pb-3 font-['DM font-semibold text-black text-base leading-tight Sans']">
          Featured Servers
        </div>

        <div
          className="flex flex-wrap justify-start gap-2 max-h-[calc(100vh-412px)] overflow-y-auto hide-scrollbar">
          {
            tab === 'home' &&
            <>
              {
