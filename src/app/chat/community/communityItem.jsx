...
const CommunityItem = ({ id, image }) => {
    return (
      <button
        className="inline-flex relative flex-col justify-start items-start bg-gray-100 border border-gray-100 rounded-xl max-w-[320px] h-[276px]">
                  <Image
                  ...
                  <div data-svg-wrapper className="top-[140px] left-[18px] absolute">
                    <svg
                      ...
                      <rect x="1.33337" y="1" width="38" height="38" rx="7" fill="#10B981" />
                      <rect
                        x="1.33337"
                        y="1"
                        width="38"
                  ...
                  <div
                    className="flex flex-col justify-center items-center self-stretch gap-1 p-5 h-[116px]">
                    <div className="inline-flex justify-start items-center self-stretch gap-1">
                      <div className="relative w-4 h-4 overflow-hidden">
                        <div className="top-[0.51px] left-[0.50px] absolute w-[15px] h-[14.99px]">
                          <div
                            className="top-[4.21px] left-[3.31px] absolute bg-white w-[8.62px] h-[6.94px]" />
                      ...
                      <div
                        className="font-['DM font-medium text-gray-500 text-base leading-tight Sans']">
                        Server {id}
                      </div>
                    </div>
                    ...
                    <div className="inline-flex justify-start items-center self-stretch gap-2.5">
                      <div className="flex justify-start items-center gap-1">
                        ...
                        <div
                          className="font-['DM font-normal text-[#12b669] text-[8px] leading-3 Sans']">
                          1,456,156 Online
                        </div>
                      </div>
                      <div className="flex justify-start items-center gap-1">
                        ...
                        <div
                          className="font-['DM font-normal text-[8px] text-gray-500 leading-3 Sans']">
                          2,123,241 Members
                        </div>
                      </div>
                    </div>
