      ...
      {!isLoggedIn ? (
        <>
          ...
          <div className="flex gap-2 w-[265px] items-center justify-end">
            <Link href="/sign-up">
              <button
                className="py-3 px-7 bg-gradient-to-r from-gradientStart to-gradientEnd rounded-lg font-jost text-base text-white">
                Register
              </button>
            </Link>
            <Link href="/sign-in">
                    ...
                    <div className="flex px-5 py-3 gap-2.5 items-center">
                      <div className="relative w-10 h-10">
                        <Image
                          ...
                          className="rounded-full" />
                        <div
                          className="absolute w-2.5 h-2.5 bottom-0 right-0 bg-green400 rounded-full border border-solid border-white" />
                      </div>
                      <div>
