...
const Header = ({
  ...
  return (
    <div
      className={`px-10 py-7 h-[10vh] flex flex-row items-center justify-between ${
        white ? "bg-white" : ""
      ...
      {!isLoggedIn ? (
        <>
          ...
          <div className="flex justify-end items-center gap-2 w-[265px]">
            <Link href="/sign-up">
              <button
                className="bg-gradient-to-r from-gradientStart to-gradientEnd px-7 py-3 rounded-lg font-jost text-base text-white">
                Register
              </button>
            </Link>
            <Link href="/sign-in">
                    ...
                    <div className="flex items-center gap-2.5 px-5 py-3">
                      <div className="relative w-10 h-10">
                        <Image
                          ...
                          className="rounded-full" />
                        <div
                          className="right-0 bottom-0 absolute border-white bg-green400 border border-solid rounded-full w-2.5 h-2.5" />
                      </div>
                      <div>
