...
const Plan = () => {
  const PlanList = [
    ...
    {
      title: "$20/month.",
      content: "Unlock comprehensive features",
    },
    {
      title: "Contact us.",
      content:
        "For top-tier professionals, with exclusive tools and priority search placement.",
    },
  ];
  ...
  return (
    <div className="relative flex justify-center w-full" id="explore-plan">
      ...
      <motion.div
        className="max-w-[1440px] flex flex-col gap-16 items-center"
        initial="hidden"
        whileInView="visible"
        ...
        <motion.div
          ...
          {PlanList.map((item, index) => (
            <motion.div
              ...
              variants={fadeIn}>
              <div
                className="relative z-10 bg-gray100 h-[230px] rounded-lg flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col gap-8">
          <motion.span className="font-jost text-xl text-center" variants={fadeIn}>
