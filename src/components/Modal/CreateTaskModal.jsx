...
const CreateTaskModal = ({
  ...
  const [tmTask, setTmTask] = useState({ project: projectId });
  ...
  return (
    <div
      className="fixed inset-0 bg-[#17171819] flex justify-center items-center z-50 p-4">
      <div
        ref={modalRef}
        ...
        <div className="border-b pb-4">
          <div className="flex justify-between items-center">
            ...
            <button className="text-gray500 hover:rotate-90 transition-all" onClick={onClose}>
        ...
        <div className="grid grid-cols-2 gap-4">
          {/* <div className="flex flex-col gap-2.5">
            ...
            <select className="w-full px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                {filteredAssignee.length > 0 && (
                  <ul
                    className="absolute z-10 bg-white border border-gray-200 rounded-lg shadow-lg mt-[70px] max-h-60 overflow-auto">
            ...
            <div
              className="w-80 flex flex-col sm:flex-row border p-2 rounded-md items-center justify-between gap-2">
              ...
              <div className="relative">
                ...
                <span
                  className="absolute h-4 w-4 bg-gray500 rounded-full top-0.5 left-0.5 transition-transform duration-300 peer-checked:translate-x-4 peer-checked:bg-white"></span>
              </div>
            </div>

            <div className="flex justify-center mt-2">
              <button
                className="w-full sm:w-48 bg-gradient-to-r from-gradientStart to-gradientEnd text-white font-medium px-8 py-2.5 rounded-lg hover:shadow-lg transition"
