...
const ProjectOverviewModal = ({
    ...
    const fetchUserData = () => {
      axios
        ...
        .then(res => {
          setInputValue('');
          axios
            .post(`${apiUrl}/api/tmProjects/role`, {
            user: res.data._id,
  ...
  const handleChangeRole = (member) => (event) => {
      ...
      <div
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2.5">
            ...
            <div
              className="flex items-center gap-0 rounded-lg overflow-hidden border border-gray200 bg-gray200 w-full focus-within:ring-2 focus-within:ring-green500">
              <input
                type="email"
        ...
        <div className="flex justify-end items-center">
          <button
            className="text-gray500 text-sm p-2 border rounded-md hover:bg-gray100 flex items-center gap-2 transition-all">
