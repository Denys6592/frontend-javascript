...
const HeaderModal = () => {
  return (
    <div className="absolute top-full right-0 pt-2 z-10">
      <div
        className="flex flex-col gap-6 bg-white shadow-lg rounded-lg w-80 max-h-[420px] px-5 py-7 drop-shadow-md">
        <h3 className="font-semibold text-lg">Recent Activity</h3>
        <ul
          className="flex h-full flex-col gap-4 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:rounded-full">
          <li className="flex items-start gap-3">
            <div
              className="w-7 h-7 flex items-center justify-center rounded-full bg-green500">
          ...
          <li className="flex items-start gap-3">
            <div
              className="w-7 h-7 flex items-center justify-center rounded-full bg-[#7784EE]">
          ...
          <li className="flex items-start gap-3">
            <div
              className="w-7 h-7 flex items-center justify-center rounded-full bg-yellow500">
