...
const BuiltFor = () => {
  ...
  return (
    <div className="relative w-full flex justify-center" id="core-features">
      ...
      <div className="max-w-[1440px] flex flex-col gap-48">
        <div className="flex flex-col justify-center gap-16">
          ...
          <div className="flex items-center justify-between gap-12">
            ...
            <div className="flex flex-col items-start justify-start basis-1/2">
              <motion.h3
                className="font-medium text-[32px] text-black"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.5 }}
                variants={fadeIn}>
              ...
              <motion.span
                className="font-jost text-xl mt-1"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.5 }}
                variants={fadeIn}>
                ...
                {FeaturesList.map((item, key) => (
                  <div
                    ...
                    {selected === key ? (
                      ...
                      <div
                        className="absolute inset-0 rounded-lg bg-gradient-to-r from-gradientStart to-gradientEnd group-hover:opacity-0 transition-all"></div>
                    )}
                  </div>
                ))}
              </motion.div>
              ...
              <motion.div
                ...
                <Link
                  href="/sign-up"
                  className="px-7 py-3 bg-gradient-to-r from-gradientStart to-gradientEnd rounded-lg">Start Freelancing Career</Link>
              </motion.div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-12">
          <div className="flex flex-col gap-10">
            ...
            <div className="grid grid-cols-2 gap-5">
              <motion.div
                ...
                variants={fadeIn}>
                <div
                  className="relative flex flex-col h-full z-10 bg-white group-hover:bg-transparent group-hover:text-white rounded-lg p-5 transition-all">
                  <Icons.escrow
                    width="30"
                    height="30"
                ...
                <div
                  className="absolute inset-0 rounded-lg bg-gradient-to-r from-gradientStart to-gradientEnd"></div>
              </motion.div>
              <motion.div
                className="group relative inline-block p-[1px]"
                initial="hidden"
          ...
          <motion.div
            className="text-[120px] leading-none text-transparent bg-clip-text bg-gradient-to-r from-gradientStart to-gradientEnd"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
            variants={fadeIn}>
